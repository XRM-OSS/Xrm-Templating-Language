...
- XTL placeholders are identified using ${placeholder} patterns currently. Please take care that your placeholder does not contain any } chars, as this would break the placeholder.
